<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Deposit_Page.aspx.cs" Inherits="ATM.Deposit_Page" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Deposit</title>    <meta charset="utf-8" />
    ...
    <div class="input-group-append">
        <span class="input-group-text toggle-password" onclick="togglePasswordVisibility()">
            <i class="fas fa-eye" id="toggleIcon"></i>
             ...
             <asp:TextBox ID="txtDeposit" runat="server" CssClass="form-control" TextMode="Number" placeholder="Enter Amount" Required="true"></asp:TextBox>
             <br />
