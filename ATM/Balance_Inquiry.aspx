<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Balance_Inquiry.aspx.cs" Inherits="ATM.Balance_Inquiry" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Balance Enquiry - RM_Bank</title>
    <meta charset="utf-8" />
...
<body>
  ...
  <div class="header">
    ...
    <input type="password" id="password" runat="server" name="password" placeholder="Enter pin" class="form-control" required />
    <div class="input-group-append">
        <span class="input-group-text toggle-password" onclick="togglePasswordVisibility()">
            <i class="fas fa-eye" id="toggleIcon"></i>
                ...
                <br /><br />
                <h2>Balance available in your account</h2>
                <!-- Display balance after PIN verification -->
                <div style="color:mediumpurple;font-family:'Times New Roman';font-size:40px;font-weight:400">
